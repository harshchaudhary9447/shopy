        ...
        <section>
          <MaxWidthWrapper className="py-24">
           ...
           <div className="mb-12 px-6 lg:px-8">
              ...
              <h2 className="order-1  mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
                Upload your photo <span className="relative px-2 bg-green-500 text-white">your own case</span> 
              </h2>
              </div>
           </div>
           ...
           <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              <img src="/arrow.png" className="absolute top-[25rem] md:top-1/2 -translate-x-1/2 z-10 left-1/2 -translate-y-1/2  rotate-90 md:rotate-0 "></img>
           ...
           <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            <li className="w-fit">
              <Check className="h-5 w-5 text-green-400 inline mr-1.5"/>
